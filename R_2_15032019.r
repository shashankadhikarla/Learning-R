# Continuation of R_1_15032019 
# We shall be adding, committing and pushing to GitHub 
...
*** Please tell me who you are. # Lol; Configuration needs to be done. 
...
guest@AND010:~/.mozilla/firefox/Learning-R$ git config --global user.email "ashashankvishwanath@gmail.com" # Git ID email
guest@AND010:~/.mozilla/firefox/Learning-R$ git config --global user.name "shashankadhikarla" # Git ID User Name
